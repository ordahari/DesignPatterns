...
namespace FactoryMethod.Pizza
{
    ...
    {
        public ClamPizza(string name, IPizzaIngredientsFactory pizzaIngredientsFactory) : base(name, pizzaIngredientsFactory)
        {
        }
        ...
        public override void Prepare()
        {
            ...
            clams = _pizzaIngredientsFactory.CreateClams();
        }
    }
}
